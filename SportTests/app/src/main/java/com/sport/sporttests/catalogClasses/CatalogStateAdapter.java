package com.sport.sporttests.catalogClasses;
...
import com.sport.sporttests.DownloadImageTask;
import com.sport.sporttests.R;
import com.sport.sporttests.question_classes.QuestionActivity;
...
public class CatalogStateAdapter extends RecyclerView.Adapter<CatalogStateAdapter.ViewHolder>{
    ...
    @Override
    public CatalogStateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.catalog_list_item, parent, false);
        return new CatalogStateAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CatalogStateAdapter.ViewHolder holder, int position) {
