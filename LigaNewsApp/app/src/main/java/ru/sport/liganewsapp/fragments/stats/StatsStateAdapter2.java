...
public class StatsStateAdapter2 extends RecyclerView.Adapter<StatsStateAdapter.ViewHolder>{

    private final LayoutInflater inflater;
    private final List<StatsState2> states;

    public StatsStateAdapter2(Context context, List<StatsState2> states) {
        this.states = states;
    ...
    public void onBindViewHolder(StatsStateAdapter.ViewHolder holder, int position) {
        StatsState2 state = states.get(position);
