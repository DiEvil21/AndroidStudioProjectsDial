...
public class TableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        url = "http://159.69.90.204/api/LigaApp/table.json";
    ...
    private void setInitialData(String st0, String st1,String st2,String st3,String st4,String st5,String st6,String st7,String st8) {

        states.add(new TableState(st0 ,st1,st2,st3,st4,st5,st6,st7,st8));
    }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // создаем адаптер
                        TableStateAdapter adapter = new TableStateAdapter(view.getContext(), states);
