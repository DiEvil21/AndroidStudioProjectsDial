...
public class DataStateAdapter extends RecyclerView.Adapter<DataStateAdapter.ViewHolder>{
    ...
    @Override
    public DataStateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.list_item, parent, false);
        return new DataStateAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DataStateAdapter.ViewHolder holder, int position) {
